    ...
    <section className="py-56 md:py-20">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex justify-center flex-wrap gap-8">
          <article data-aos="flip-right" className="bg-gray-100 relative rounded-xl shadow-xl p-6 w-[480px] h-[250px] overflow-hidden flex flex-col-reverse items-center md:items-start md:flex-row justify-between text-center md:text-left">
            <div>
          ...
          <article data-aos="flip-left" className="bg-gray-100 relative rounded-xl shadow-xl p-6 w-[480px] h-[250px] overflow-hidden flex flex-col-reverse items-center md:items-start md:flex-row justify-between text-center md:text-left">
            <div>
          ...
          <article data-aos="flip-right" className="bg-gray-100 overflow-hidden relative rounded-xl shadow-xl p-6 w-[480px] h-[250px] flex flex-col-reverse items-center md:items-start md:flex-row justify-between text-center md:text-left">
            <div>
          ...
          <article data-aos="flip-left" className="bg-gray-100 overflow-hidden relative rounded-xl shadow-xl p-6 w-[480px] h-[250px] flex flex-col-reverse items-center md:items-start md:flex-row justify-between text-center md:text-left">
            <div>
