    ...
    <section className="py-8 md:py-20">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex justify-center flex-wrap gap-8">
          <article className="bg-gray-200 rounded p-6 w-[480px] flex flex-col-reverse items-center md:items-start md:flex-row justify-between text-center md:text-left">
            <div>
