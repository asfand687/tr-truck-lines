...
const HomeStatsSection = () => {
  return (
    <section className="relative h-[700px]">
      <div className="absolute top-0 left-0 w-full h-[700px] z-10 bg-black opacity-80" />
      <div className="absolute left-0 z-0 top-0 w-full h-[700px]  bg-blue-500 ">
        <img src={Trucks} alt="Trucks" className="w-full h-[700px] object-cover" />
      </div>
      <div className="relative z-20 w-full max-w-5xl mx-auto flex flex-col justify-center font-bold pt-16">
        <div className="h-[6px] w-36 bg-yellow-600 mb-6" />
        <h2 className="text-5xl text-white">
          Our Milestones
        </h2>
        <div className="flex justify-center items-center gap-x-16 pt-24 py-16">
          <article className="flex px-8 flex-col items-center text-center border-r-[0.25px] border-gray-500">
