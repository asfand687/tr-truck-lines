  ...
  return (
    <section className="h-screen md:h-[calc(100vh-65px)]">
      <div className="relative">
        <div className="fixed left-10 bottom-10 bg-gray-800 rounded-full z-50 w-16 h-16 flex justify-center items-center animate-pulse">
          <AiTwotonePhone className="relative z-20 text-5xl text-yellow-400" />
          <div className="absolute z-10 w-20 h-20 rounded-full bg-gray-500 animate-ping"></div>
        </div>
